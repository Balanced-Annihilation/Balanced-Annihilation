...
teamDeathMessages = {
	...
	"XX travelled to the undying lands",
	...
	"XX doesn't feel too good",
	"XX will watch the universe expand",
	"Sometimes bad things happen to good XXs",
	"XX gave all that they are",
	"XX was taken home by darkness",
	"All the light is gone from XX",
	"XX's bridges were burned",
	"XX faked their own death",
	"XX fell off the edge of the world",
	"XX's clock reached zero",
	"XX's battery ran out",
	"XX reached DEFCON 0",
	"XX picked on the wrong guy",
	"XX showed their hand",
	"XX uninstalled their pizza",
	"XX was living in a house of cards",
	"XX was watching the price of beans go up",
	"XX grew their last potato",
	"XX popped out of existance",
	"XX won't be needing their umbrella back",
	"XX's light went out and there is no one home"
	"XX had an appointment with destiny" ,
	"XX was in the wrong place at the wrong time",
	"XX Lost their lucky socks",
	"XX disabled safe mode",
	"XX sailed beyond the baths of all the western stars",,
	"XX was a lamb to the cosmic slaughter",,
	"XX realised there are no weak players in BA",
	"XX passed the great filter",
	"XX blamed it on the music",
	"XX will be retroactively rewritten out of history" ,
	"XX ran out of time",
	"XX was relegated to mythology",
	"There are universes without limits, XX was only limited by themself",
	"XX was hit by an orbital ion cannon",
	...
	"XX learns to win by losing",
	"XX departed to the sands of gold",
	"XX could not stop the future",
	"Not all who wander are lost, but XX sure was",
	"XX never felt like they were in danger",
	"XX's world was left in ruins",
	"XX doesn't even know whose side they are on",
	"XX will now permanently remove the unit that killed them from the game",
	"XX was an experiment to test the lucidity and the beliefs of the people",
	"XX stumbled",
	"XX will fix everything with balance updates",
	"XX returned to their home planet",
	"XX was not ready for a bit of the old ultra-violence",
	"XX won't hestitate again",
	"XX disembarked the hype train",
	"Where XX is going we won't need roads",
	"XX cannot comprehend danger",
	"XX eyes were open, but they did not see",
	"XX didn't know how to leave",
	"What heart XX had has now stopped",
	"XX was a conversation scrubbed out on the page",
	"XX will be found in those that are to come",
	"XX will not die again",
	"XX did not understand art",
	"XX will now remain quiet",
	"XX's fight went on as long as it had to",
	"XX missed a frame perfect input",
	"XX will be added back as a modoption",
	"XX has no further questions",
	"XX put on a great show",
	"XX failed to negotiate",
	"XX won't come back no more",
	"XX became a discarnate being",
	"The world spun in XX's eyes",
	"XX was willed out of existence",
	"XX will keep their secrets",
	"XX watched the last domino fall",
	...
	"XX ceased to be, before they arrived",
	"As if under the yoke, XX could never turn around and look backwards",
	"XX was afraid of his own memory",
	"XX dares not revisit the past",
	"XX's past is certain and future doubtful",
	"The life of XX was preoccupied and very short",
	"XX has not lived long, but long existed",
	"XX is not afraid of the next day",
	"It took XX a whole lifetime to learn how to die",
	"XX submitted an admin report on the unfairness of losing",
	"XX won't force you to die, but he will show you how",
	"XX transcended the narrow limitations of weakness",
	"XX withdrew to a more peaceful haven",
	"XX is best admired from a safe distance",
	"XX asked how many rowers Ulysses had",
	"XX underestimated the danger they were in",
	"XX demanded trial by combat",
	"XX provides this notice without admission of liability",
	"XX found their new equilibrium",
	"Defeat is an illusion, XX lost because they believed it was real",
	...
	"XX self-d by accident while trying to delete their wind gens",
	"XX is free",
	...
	"XX accepted their new unreality",
	...
	"XX has fallen out of favour",
	"XX would like to retract his previous statement",
	"XX does not expect any more problems",
	"XX's terms and conditions just changed",
	"XX is a small seal rolling down a big hill",
	"XX would like to offer you a complementary pen as a gesture of goodwill",
	"XX tried to make the game more fun, but accidentally made it less fun",
	"XX would like you to offer you this short message as compensation for your loss",
	"XX was just a hologram all along",
	"XX's policy is not to comment on ongoing matters",
	"This is a placeholder message while XX's PR team comes up with a better one",
	"XX's lawyer would like to inform you that XX is not responsible for what just happened",
	"XX must go now, his people need him",
	"XX is going home",
	"XX wants to play a more blue map",
	"XX's history was rewritten",
	"XX's pastries are gone",
	"XX was removed to clear the air",
	"XX was overwhelmed by the sheer number of buttons",
	"XX was busy typing",
	"XX is like flobber, he is happy",
	"XX would like to revise this inconvenience",
	"XX never got a fair trial",
	"XX always knew the chickens were up to something",
	"XX was overjunoed",
	...
	"XX will return one day, stronger and more determined than ever",
	"XX was struck by a falling turtle",
	"What XX lacked in skill they make up for with kindness",
	"XX now has an opportunity to reflect on where they went wrong",
	"XX needs some time for quiet introspection",
	"XX migrated their JSON to incorrectly formatted YAML",
	"XX's keybinds are kicking in",
	"XX IS BLOWDEN!",
	"XX followed Mando into a minefield",
	"XX was banished to the shadow realm",
	"XX forgot to reclaim their teammates for metal",
	"XX's continent was IP banned",
	"XX went looking for Zerver",
	"XX needed more mortys",
	"XX is trolling the poor Mando",
	"XX has been known to troll in the past",
	"XX's official website has been redirected",
	"XX experienced reduced support for their engine version",
	"XX now only runs on 64 bit Windows",
	"XX's branch was removed from the engine",
	"XX noticed springfiles seems to be down",
	"XX said hooray for extra explodifications",
	...
	"XX had to be removed for security reasons",
	"XX questioned the wisdom of Mando",
	"XX relicensed all their widgets",
	"XX's widgets became sentient and forced them to lose against their will",
	"XX encountered a problem and must restart",
	...
	"XX request for a botflag was denied",
	...
	"XX will see you in court",
	"XX did that on purpose",
	"XX meant for that to happen",
	"XX's pet alligator grew up",
	...
	"XX had a once in a lifetime experience",
	"XX had a large margin for error",
	"XX learns by trial and error",
	"XX had a change of management",
	"XX was re-aligned to new business objectives",
	...
	"XX has decided to pursue other interests",
	"XX will require an additional round of funding",
	"The real winners were the friendships XX made along the way",
	"XX's tears fell like rain",
	"XX did not fear death",
	"XX would like to suggest a new balance change",
	"XX was never expecting to win",
	"XX died due to a poorly written Trueskill algorithm",
	"All that remains of XX is a bittersweet memory",
	"XX had a box of dreams that never came true",
	"XX didn't know what to do",
	"XX was the saddest story of our time",
	"XX went gently into that good night",
	"XX joined the giant peewee in the sky",
	"Even though XX was defeated, Mando will always be by their side",
	"XX shed their last tear and whispered the name of Mando",
	"XX was a sweet summer day that will last forever",
	"XX was helpless in the face of destiny",
	"XX refused to say a funny death message",
	"XX likes surprises",
	"XX made poor unit choices",
	"XX was forgiven by Mando",
	"XX started developing a new lobby client",
	"XX urgently wants to vote for SandOfMinesV2",
	"XX tried to understand Springlobby code",
	"XX purchased the paid version",
	"XX remembered Mando",
	"XX tried to play on the official server",
	"XX was rebalanced",
	"XX destroyed Mando's speakers",
	"XX tried to 1v1 Cartouche",
	"XX tried to rebalance BA",
	"XX was just a guinea pig for the engine devs all along",
	"XX speakers were destroyed",
	"XX thought of poor Mando",
	"XX encountered an internal bug from an external trueskill plugin",
	"XX had less eco",
	"XX forgot to make air",
	"XX should have made AFUS",
	"XX was not looking at their commander",
	"XX was not OP",
	...
	"XX exploded",
	"XX will be back",
	"XX is forgiven but not forgotten",
	...
	"XX went up the creek and merrily discarded its one and only paddle",
	...
	"XX died riding a squealing hog, firing a shotgun into the air",
