	   ...
	   local u = GetTheOne()
        ...
        if u then
            ...
            msg = msg .. " U:" .. u
			  ...
			  if Spring.GetKeyState(103) and (frame > (pressFrame + 45)) then --down o --was 15
            ...
            if Spring.GetKeyState(103) then --111 down o
                local alt, ctrl, meta, shift = Spring.GetModKeyState()
            ...
            for _, p in ipairs(Spring.GetPlayerList()) do
                ...
                if u and Spring.ValidUnitID(u) then
                    ...
                    if p ~= Spring.GetLocalPlayerID() then --
                        ...
                        if (UnitDefs[Spring.GetUnitDefID(u)] == shiva) then
