...
if gadgetHandler:IsSyncedCode() then
	...
	local function playerLagging(_, playerName)
                    Spring.Echo("Player " .. playerName .. " is lagging behind")
	end

	local function playerResumed(_, playerName)
                    Spring.Echo("Player " .. playerName .. " has finished resuming")
	end

	local function playerAFK(_, allyTeamID, playerName)
                    Spring.SendMessageToAllyTeam(allyTeamID,"Player " .. playerName .. " went AFK")
	end

	local function playerReturned(_, allyTeamID, playerName)
                    Spring.SendMessageToAllyTeam(allyTeamID,"Player " .. playerName .. " came back")
	end
