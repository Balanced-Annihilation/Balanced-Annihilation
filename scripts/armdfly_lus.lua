...
function script.Killed()
		...
		Explode(link0, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE + SFX.FALL + SFX.NO_HEATCLOUD)
		Explode(jets, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE + SFX.FALL +SFX.SHATTER+ SFX.NO_HEATCLOUD )
		Explode(patch, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE + SFX.FALL + SFX.NO_HEATCLOUD )
		Explode(leg1, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE +SFX.SHATTER + SFX.NO_HEATCLOUD)
		Explode(leg3, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE +SFX.SHATTER +SFX.NO_HEATCLOUD )
