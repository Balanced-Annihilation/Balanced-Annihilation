...
function script.Killed()
		...
		Explode(thrust1, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE +SFX.SHATTER  + SFX.NO_HEATCLOUD)
		Explode(arm2, SFX.EXPLODE_ON_HIT + SFX.SMOKE + SFX.FIRE  +SFX.SHATTER + SFX.NO_HEATCLOUD)
