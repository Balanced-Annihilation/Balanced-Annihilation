...
--NUKE EXPLOSIONS WITH DAMAGE--
    ...
    commanderexplosion1 = {
		...
		weaponType = "Cannon",
		AreaOfEffect = 720*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		cameraShake = 720*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		impulseboost = 3*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		impulsefactor = 3*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION1",
		range = 380*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		weaponvelocity = 250*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		craterboost = 6*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		cratermult = 3*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		edgeeffectiveness = 0.25,
		reloadtime = 3.5999999046326,
		turret = 1,
		damage = {
			default = 50000*(3/4)*(3/4)*(3/4)*(3/4)*(3/4),
		},
	},
    commanderexplosion2 = {
		name = "Matter/AntimatterExplosion",
		weaponType = "Cannon",
		AreaOfEffect = 720*(3/4)*(3/4)*(3/4)*(3/4),
		cameraShake = 720*(3/4)*(3/4)*(3/4)*(3/4),
		impulseboost = 3*(3/4)*(3/4)*(3/4)*(3/4),
		impulsefactor = 3*(3/4)*(3/4)*(3/4)*(3/4),
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION2",
		range = 380*(3/4)*(3/4)*(3/4)*(3/4),
		weaponvelocity = 250*(3/4)*(3/4)*(3/4)*(3/4),
		craterboost = 6*(3/4)*(3/4)*(3/4)*(3/4),
		cratermult = 3*(3/4)*(3/4)*(3/4)*(3/4),
		edgeeffectiveness = 0.25,
		reloadtime = 3.5999999046326,
		turret = 1,
		damage = {
			default = 50000*(3/4)*(3/4)*(3/4)*(3/4),
		},
	},
    commanderexplosion3 = {
		name = "Matter/AntimatterExplosion",
		weaponType = "Cannon",
		AreaOfEffect = 720*(3/4)*(3/4)*(3/4),
		cameraShake = 720*(3/4)*(3/4)*(3/4),
		impulseboost = 3*(3/4)*(3/4)*(3/4),
		impulsefactor = 3*(3/4)*(3/4)*(3/4),
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION3",
		range = 380*(3/4)*(3/4)*(3/4),
		weaponvelocity = 250*(3/4)*(3/4)*(3/4),
		craterboost = 6*(3/4)*(3/4)*(3/4),
		cratermult = 3*(3/4)*(3/4)*(3/4),
		edgeeffectiveness = 0.25,
		reloadtime = 3.5999999046326,
		turret = 1,
		damage = {
			default = 50000*(3/4)*(3/4)*(3/4),
		},
	},
	    commanderexplosion4 = {
		name = "Matter/AntimatterExplosion",
		weaponType = "Cannon",
		AreaOfEffect = 720*(3/4)*(3/4),
		cameraShake = 720*(3/4)*(3/4),
		impulseboost = 3*(3/4)*(3/4),
		impulsefactor = 3*(3/4)*(3/4),
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION4",
		range = 380*(3/4)*(3/4),
		weaponvelocity = 250*(3/4)*(3/4),
		craterboost = 6*(3/4)*(3/4),
		cratermult = 3*(3/4)*(3/4),
		edgeeffectiveness = 0.25,
		reloadtime = 3.5999999046326,
		turret = 1,
		damage = {
			default = 50000*(3/4)*(3/4),
		},
	},
	    commanderexplosion5 = {
		name = "Matter/AntimatterExplosion",
		weaponType = "Cannon",
		AreaOfEffect = 720*(3/4),
		cameraShake = 720*(3/4),
		impulseboost = 3*(3/4),
		impulsefactor = 3*(3/4),
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION5",
		range = 380*(3/4),
		weaponvelocity = 250*(3/4),
		craterboost = 6*(3/4),
		cratermult = 3*(3/4),
		edgeeffectiveness = 0.25,
		reloadtime = 3.5999999046326,
		...
		soundhit = "newboom",
		soundstart = "largegun",
		explosiongenerator="custom:COMMANDER_EXPLOSION6",
		range = 380,
		weaponvelocity = 250,
		craterboost = 6,
		cratermult = 3,
