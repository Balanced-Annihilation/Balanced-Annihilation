return {
	corasy = {
		...
		waterline = 32,
		workertime = 400,
		yardmap = "wCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCwwCCCCCCCCCCw",
		buildoptions = {
			[1] = "coracsub",
			[2] = "cormls",
			[3] = "corshark",
