return {	["COMMANDER_EXPLOSION5"] = {
		...
		innersmoke = {
			...
			properties = {
				...
				airdrag=0.66,
				particleLife=20*(3/4),
				particleLifeSpread=200*(3/4),
				numParticles=60*(3/4),
				particleSpeed=2*(3/4),
				particleSpeedSpread=70*(3/4),
				particleSize=30*(3/4),
				particleSizeSpread=6*(3/4),
				directional=1,
			},
		},
		...
		outersmoke = {
			...
			properties = {
				...
				airdrag=0.77,
				particleLife=10*(3/4),
				particleLifeSpread=150*(3/4),
				numParticles=220*(3/4),
				particleSpeed=15*(3/4),
				particleSpeedSpread=40*(3/4),
				particleSize=25*(3/4),
				particleSizeSpread=6*(3/4),
				directional=1,
			},
		...
		dirt = {
			...
			properties = {
				...
				directional        = true,
				emitrot            = 30,
				emitrotspread      = 35*(3/4),
				emitvector         = [[0, 1, 0]],
				gravity            = [[0, -0.5, 0]],
				numparticles       = 40*(3/4),
				particlelife       = 40*(3/4),
				particlelifespread = 13*(3/4),
				particlesize       = 3.2*(3/4),
				particlesizespread = -2.7*(3/4),
				particlespeed      = 9*(3/4),
				particlespeedspread = 15*(3/4),
				pos                = [[0, 10, 0]],
				sizegrowth         = 0,
				sizemod            = 1,
		...
		dirtbig = {
			...
			properties = {
				...
				directional        = true,
				emitrot            = 30,
				emitrotspread      = 25*(3/4),
				emitvector         = [[0, 1, 0]],
				gravity            = [[0, -0.7, 0]],
				numparticles       = 33*(3/4),
				particlelife       = 38*(3/4),
				particlelifespread = 15*(3/4),
				particlesize       = 4*(3/4),
				particlesizespread = -3.3*(3/4),
				particlespeed      = 8*(3/4),
				particlespeedspread = 15*(3/4),
				pos                = [[0, 10, 0]],
				sizegrowth         = 0,
		...
		sparks = {
			...
			properties = {
				...
				directional        = true,
				emitrot            = 40*(3/4),
				emitrotspread      = 40*(3/4),
				emitvector         = [[0, 1, 0]],
				gravity            = [[0, -0.18, 0]],
				numparticles       = 15*(3/4),
				particlelife       = 33*(3/4),
				particlelifespread = 22*(3/4),
				particlesize       = 6*(3/4),
				particlesizespread = 6*(3/4),
				particlespeed      = 16*(3/4),
				particlespeedspread = 8*(3/4),
				pos                = [[0, 4, 0]],
				sizegrowth         = 0,
				sizemod            = 1,
				texture            = [[gunshotglow]],
