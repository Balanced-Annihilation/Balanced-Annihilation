...
local damageTypes = {
	...
	laser={"armfast","armflea","armwar","cormando","corfav","armsubk","corshark","armjanus","corgator",},
	...
	omni={"armshock","corjugg","armamd","corfmd","armcarry","corcarry","armscab","cormabm","armsd","corsd","armcom","armcom2","armcom3","armdecom","corcom","corcom2","corcom3","cordecom","meteor","armjuno","armjamt","armveil","corjuno","corjamt","corshroud","armfhp","armhp","corfhp","corhp","armsy","asubpen","armaap","armalab","armap","armasy","armavp","armlab","armplat","armshltx","armshltxuw","armvp","coraap","coralab","corap","corasy","coravp","corgant","corgantuw","corlab","corplat","corsy","corvp","csubpen","armspy","armfark","armaser","armvulc","armfmine3","armmine1","armmine2","armmine3","corfmine3","cormine1","cormine2","cormine3","cormine4","armsilo","armvader","corroach","corthovr","armthovr","corintr","armtship","cortship","coreter","corfgate","corgate","armfgate","armgate",},
