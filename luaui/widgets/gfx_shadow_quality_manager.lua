...
local maxQuality			= 4096
local minQuality			= 1024		-- I dont think a value below 2048 looks acceptable enough... wont free that much extra cpu power too
local disableBelowMinimum	= true
local skipGameframes		= 1611		-- dont check if quality change is needed for X gameframes
local fpsDifference			= 15				-- if fps differs X amount, then shadow quality will be allowed to change. (we dont want frequent changes because these are causing extra cpu load, also spring spams an echo each time)
