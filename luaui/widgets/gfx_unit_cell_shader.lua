...
function widget:GetInfo()
	return {
		name      = "Unit Cell Shader", --Outline No Shader
...
local forceLowQuality = true
local scaleWithHeight = true
local functionScaleWithHeight = false
...
local function DrawVisibleUnitsLines(underwater, frontLines) 
	...
	if underwater then
		gl.LineWidth(0.8 * thickness * thicknessMult)
...
function widget:Update(dt)
	...
	thicknessMult = 12000/cameraHeight
end
