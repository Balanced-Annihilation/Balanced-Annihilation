...
{id="msaa", name="Anti Aliasing", type="slider", min=0, max=4, step=2, value=tonumber(Spring.GetConfigInt("MSAALevel",2) or 2), description='Requires restart, reduce jagged edges.'},
--	{id="water", name="Water type", type="select", options={'basic','reflective','dynamic','reflective&refractive','bump-mapped'}, value=(tonumber(Spring.GetConfigInt("Water",1) or 1)+1)},
{id="water", name="Water type", type="select", options={'basic','reflective','dynamic','reflective&refractive','bump-mapped'}, value=(tonumber(Spring.GetConfigInt("Water",1) or 1)+1)},
